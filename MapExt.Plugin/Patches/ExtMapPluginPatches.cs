...
namespace MapExtPlugin.Patches
{
    ...
    internal static class AirPollutionSystemPatch
    {
        ...
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            CellMapData<AirPollution> result = default(CellMapData<AirPollution>);
            result.m_Buffer = __instance.m_Map;
            result.m_CellSize = 57344 / (float2)__instance.m_TextureSize;
            result.m_TextureSize = __instance.m_TextureSize;
            __result = result;
        }

        [HarmonyPatch(typeof(CellMapSystem<AirPollution>), "GetMap")]
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<AirPollution> __instance, ref NativeArray<AirPollution> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }

        [HarmonyPatch(typeof(CellMapSystem<AirPollution>), "AddReader")]
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<AirPollution> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        
        [HarmonyPatch(typeof(CellMapSystem<AirPollution>), "AddWriter")]
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<AirPollution> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class AvailabilityInfoToGridSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<AvailabilityInfoCell> __instance, ref NativeArray<AvailabilityInfoCell> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<AvailabilityInfoCell> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<AvailabilityInfoCell> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class GroundPollutionSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<GroundPollution> __instance, ref NativeArray<GroundPollution> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<GroundPollution> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }

        [HarmonyPatch(typeof(CellMapSystem<GroundPollution>), "AddWriter")]
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<GroundPollution> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class GroundWaterSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<GroundWater> __instance, ref NativeArray<GroundWater> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<GroundWater> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<GroundWater> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class NaturalResourceSystemPatch
    {
        ...
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            CellMapData<NaturalResourceCell> result = default(CellMapData<NaturalResourceCell>);
            result.m_Buffer = __instance.m_Map;
            result.m_CellSize = 57344 / (float2)__instance.m_TextureSize;
            result.m_TextureSize = __instance.m_TextureSize;
            __result = result;
        ...
        [HarmonyPatch(typeof(CellMapSystem<NaturalResourceCell>), "GetMap")]
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<NaturalResourceCell> __instance, ref NativeArray<NaturalResourceCell> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<NaturalResourceCell> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }

        [HarmonyPatch(typeof(CellMapSystem<NaturalResourceCell>), "AddWriter")]
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<NaturalResourceCell> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class NoisePollutionSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<NoisePollution> __instance, ref NativeArray<NoisePollution> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<NoisePollution> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<NoisePollution> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class PopulationToGridSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<PopulationCell> __instance, ref NativeArray<PopulationCell> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<PopulationCell> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<PopulationCell> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class SoilWaterSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<SoilWater> __instance, ref NativeArray<SoilWater> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<SoilWater> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<SoilWater> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class TelecomCoverageSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<TelecomCoverage> __instance, ref NativeArray<TelecomCoverage> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<TelecomCoverage> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<TelecomCoverage> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class TerrainAttractivenessSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<TerrainAttractiveness> __instance, ref NativeArray<TerrainAttractiveness> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<TerrainAttractiveness> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<TerrainAttractiveness> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    {
        [HarmonyPatch(typeof(CellMapSystem<TrafficAmbienceCell>), "GetData")]
        [HarmonyPostfix]
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<TrafficAmbienceCell> __instance, ref NativeArray<TrafficAmbienceCell> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<TrafficAmbienceCell> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }

        [HarmonyPatch(typeof(CellMapSystem<TrafficAmbienceCell>), "AddWriter")]
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<TrafficAmbienceCell> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class WindSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<Wind> __instance, ref NativeArray<Wind> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<Wind> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<Wind> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class ZoneAmbienceSystemPatch
    {
        ...
        [HarmonyPatch(typeof(CellMapSystem<ZoneAmbienceCell>), "GetMap")]
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<ZoneAmbienceCell> __instance, ref NativeArray<ZoneAmbienceCell> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }

        [HarmonyPatch(typeof(CellMapSystem<ZoneAmbienceCell>), "AddReader")]
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<ZoneAmbienceCell> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }

        [HarmonyPatch(typeof(CellMapSystem<ZoneAmbienceCell>), "AddWriter")]
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<ZoneAmbienceCell> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
    ...
    internal static class LandValueSystemPatch
    {
        ...
        [HarmonyPostfix]
        public static void GetMap(CellMapSystem<LandValueCell> __instance, ref NativeArray<LandValueCell> __result, bool readOnly, ref JobHandle dependencies)
        {
            dependencies = (readOnly ? __instance.m_WriteDependencies : JobHandle.CombineDependencies(__instance.m_ReadDependencies, __instance.m_WriteDependencies));
            __result = __instance.m_Map;
        }
        ...
        [HarmonyPostfix]
        public static void AddReader(CellMapSystem<LandValueCell> __instance, JobHandle jobHandle)
        {
            __instance.m_ReadDependencies = JobHandle.CombineDependencies(__instance.m_ReadDependencies, jobHandle);
        }
        ...
        [HarmonyPostfix]
        public static void AddWriter(CellMapSystem<LandValueCell> __instance, JobHandle jobHandle)
        {
            __instance.m_WriteDependencies = jobHandle;
        }
