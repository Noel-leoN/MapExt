...
namespace MapExt.Systems
{
    ...
    /// </summary>
	public partial class NaturalResourceSystem : CellMapSystem<NaturalResourceCell>, IJobSerializable
    {
        [BurstCompile]
        ...
        {
            float2 @float = (float2)CellMapSystemRe.kMapSize / (float2)this.TextureSize;
        ...
        public new NativeArray<NaturalResourceCell> GetMap(bool readOnly, out JobHandle dependencies)
        {
        ...
        public new CellMapData<NaturalResourceCell> GetData(bool readOnly, out JobHandle dependencies)
        {
            dependencies = (readOnly ? this.m_WriteDependencies : JobHandle.CombineDependencies(this.m_ReadDependencies, this.m_WriteDependencies));
